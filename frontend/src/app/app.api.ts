...
// During local development we run the auth service on 8001 in this workspace.
// Change to http://127.0.0.1:8002/api if you want to route through the API gateway.
export const BASE_API = 'http://127.0.0.1:8001/api';
